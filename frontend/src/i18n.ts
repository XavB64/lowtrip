      ...
      fr: {
        translation: {
          ...
          home: {
            ...
            toolDescription:
              "Choisis un point de départ, un point d'arrivée et un moyen de transport pour comparer les émissions carbone de ton voyage ! Tu peux soit comparer les émissions pour un même trajet mais avec différents moyens de transport ou avec un autre voyage multimodal avec des étapes.",
          },
          form: {
